...
if __name__ == '__main__':
    ...
    results = []
    iterdata = chunking(Lines= 50000, Num_threads= num_threads) # para hacer las pruebas de optimización, cambiar num_threads por un entero no mayor que mp.cpu_count()
